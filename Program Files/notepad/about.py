...
ttk.Label(root, text="Notepad 3", font=title_font).pack()
...
ttk.Label(root, text="Version: Notepad 3.1.0", font=info_font).pack(pady=2)
ttk.Label(root, text="Made Possible By: Python 3.14.3", font=info_font).pack(pady=2)
ttk.Label(root, text="DISCLAMER: This program is not for daily use!", font=info_font).pack(pady=2)
