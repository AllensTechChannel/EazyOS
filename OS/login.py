...
def bsod(): subprocess.run([sys.executable, os.path.join(BASE_DIR, "bsod.py")])
# --- Restart function ---
def restart_program():
...
def trigger_bsod_and_exit():
    bsod()                          # Run BSOD program
    parent.after(150, parent.destroy)   # Close login screen shortly after

# Correct Tkinter binding (capital B!)
