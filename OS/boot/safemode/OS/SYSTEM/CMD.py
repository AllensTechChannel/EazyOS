...
def python_cmd():
    print("Eazy OS [EazyOS 3.1.2 (Service Pack 2) Safe Mode Edition] Made Possible By Python 3.14.3 (c) The Python Software Foundation. All rights reserved.")
...
""")
            ...
            print("CMD version: [3.1.2]")
            print("Made Possible By: Python 3.14.3")
