...
# === HELPER COMMANDS ===
def restart_program():
    play_sound(os.path.join(BASE_DIR, 'media', 'DING.wav'))
...
def open_sound():
    create_managed_window("Music Player", os.path.join(BASE_DIR, "..", "Program Files", "Sound Player", "music_player.py"))
...
popup_menu.add_command(label="EazyOS 2")
